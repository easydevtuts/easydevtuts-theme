...
register_sidebar( array( 
	...
	'before_widget'	=> '<div class="col-sm-4 col-md-12">',
	'after_widget'	=> "</div>",
	'before_title'	=> '<h3>',
	'after_title'	=> "</h3>"
	)	
...
function comments_feed_template_callback($comment, $args, $depth){
	...
	?>
		<div class="media">
			...
			<a href="<?php echo get_comment_author_url(); ?>" class="pull-left hidden-xs">
				<?php echo get_avatar(); ?>
			</a>
...
function add_reply_link_class($class){
	$class = str_replace("class='comment-reply-link", "class='btn btn-xs btn-default pull-right", $class);
	return $class;
}


/**
 * Custom Walker for Bootstrap Dropdown
 */
